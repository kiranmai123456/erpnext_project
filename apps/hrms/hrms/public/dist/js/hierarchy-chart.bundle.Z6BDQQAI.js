(() => {
  ...
  hrms.HierarchyChartMobile = class {
    ...
    get_node_group(nodes, parent, collapsed = true) {
      ...
      let html = display_nodes.map(
        (node) => this.get_avatar(node)
      ).join("");
  ...
  // frappe-html:/home/kiranmai/Documents/Hilltop/frappe-bench/apps/hrms/hrms/public/js/templates/node_card.html
...
/*! *****************************************************************************
    ...
    ***************************************************************************** */
//# sourceMappingURL=hierarchy-chart.bundle.Z6BDQQAI.js.map
